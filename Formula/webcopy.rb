class Webcopy < Formula
  ...
  on_macos do
    on_arm do
      url "https://apps-delivery.beeksiwaais.fr/webcopy/0.1.1/webcopy-darwin-arm64.tar.gz"
      sha256 "a82955604fb14957659b07f263b48787a2a324c69580a131194b7d79be865ed3"
    end
    on_intel do
      url "https://apps-delivery.beeksiwaais.fr/webcopy/0.1.1/webcopy-darwin-amd64.tar.gz"
  ...
  on_linux do
    on_intel do
      url "https://apps-delivery.beeksiwaais.fr/webcopy/0.1.1/webcopy-linux-amd64.tar.gz"
